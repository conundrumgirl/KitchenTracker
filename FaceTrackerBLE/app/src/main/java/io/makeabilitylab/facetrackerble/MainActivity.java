...
public class MainActivity extends AppCompatActivity implements BLEListener{
    ...
    private class FaceTracker extends Tracker<Face> {
        ...
        public void onUpdate(FaceDetector.Detections<Face> detectionResults, Face face) {
            ...
            byte[] buf = new byte[] { (byte) 0x03, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00}; // 5-byte initialization

            // CSE590 Student TODO:
            // Write code that puts in your data into the buffer

            buf[1]= (byte)map_range(face.getIsLeftEyeOpenProbability(), 0, 1, 0, 255);
            buf[2] = (byte)map_range(face.getIsRightEyeOpenProbability(), 0, 1, 0, 255);
            buf[3] = (byte) face.getIsSmilingProbability();
